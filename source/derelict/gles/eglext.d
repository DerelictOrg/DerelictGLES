...
package void loadEXT(  ) {
    _EGL_KHR_cl_event = isExtSupported( "EGL_KHR_cl_event" );
    _EGL_KHR_cl_event2 = isExtSupported( "EGL_KHR_cl_event2" );
    if( _EGL_KHR_cl_event2 ) load_EGL_KHR_cl_event2();
    _EGL_KHR_client_get_all_proc_addresses = isExtSupported( "EGL_KHR_client_get_all_proc_addresses" );
    _EGL_KHR_config_attribs = isExtSupported( "EGL_KHR_config_attribs" );
    _EGL_KHR_create_context = isExtSupported( "EGL_KHR_create_context" );
    _EGL_KHR_fence_sync = isExtSupported( "EGL_KHR_fence_sync" );
    _EGL_KHR_get_all_proc_addresses = isExtSupported( "EGL_KHR_get_all_proc_addresses" );
    _EGL_KHR_gl_colorspace = isExtSupported( "EGL_KHR_gl_colorspace" );
    _EGL_KHR_gl_renderbuffer_image = isExtSupported( "EGL_KHR_gl_renderbuffer_image" );
    _EGL_KHR_gl_texture_2D_image = isExtSupported( "EGL_KHR_gl_texture_2D_image" );
    _EGL_KHR_gl_texture_3D_image = isExtSupported( "EGL_KHR_gl_texture_3D_image" );
    _EGL_KHR_gl_texture_cubemap_image = isExtSupported( "EGL_KHR_gl_texture_cubemap_image" );
    _EGL_KHR_image = isExtSupported( "EGL_KHR_image" );
    if( _EGL_KHR_image ) load_EGL_KHR_image();
    _EGL_KHR_image_base = isExtSupported( "EGL_KHR_image_base" );
    _EGL_KHR_image_pixmap = isExtSupported( "EGL_KHR_image_pixmap" );
    _EGL_KHR_lock_surface = isExtSupported( "EGL_KHR_lock_surface" );
    if( _EGL_KHR_lock_surface ) load_EGL_KHR_lock_surface();
    _EGL_KHR_lock_surface2 = isExtSupported( "EGL_KHR_lock_surface2" );
    _EGL_KHR_lock_surface3 = isExtSupported( "EGL_KHR_lock_surface3" );
    if( _EGL_KHR_lock_surface3 ) load_EGL_KHR_lock_surface3();
    _EGL_KHR_platform_android = isExtSupported( "EGL_KHR_platform_android" );
    _EGL_KHR_platform_gbm = isExtSupported( "EGL_KHR_platform_gbm" );
    _EGL_KHR_platform_wayland = isExtSupported( "EGL_KHR_platform_wayland" );
    _EGL_KHR_platform_x11 = isExtSupported( "EGL_KHR_platform_x11" );
    _EGL_KHR_reusable_sync = isExtSupported( "EGL_KHR_reusable_sync" );
    if( _EGL_KHR_reusable_sync ) load_EGL_KHR_reusable_sync();
    _EGL_KHR_stream = isExtSupported( "EGL_KHR_stream" );
    if( _EGL_KHR_stream ) load_EGL_KHR_stream();
    _EGL_KHR_stream_consumer_gltexture = isExtSupported( "EGL_KHR_stream_consumer_gltexture" );
    if( _EGL_KHR_stream_consumer_gltexture ) load_EGL_KHR_stream_consumer_gltexture();
    _EGL_KHR_stream_cross_process_fd = isExtSupported( "EGL_KHR_stream_cross_process_fd" );
    _EGL_KHR_stream_fifo = isExtSupported( "EGL_KHR_stream_fifo" );
    if( _EGL_KHR_stream_fifo ) load_EGL_KHR_stream_fifo();
    _EGL_KHR_stream_producer_aldatalocator = isExtSupported( "EGL_KHR_stream_producer_aldatalocator" );
    _EGL_KHR_stream_producer_eglsurface = isExtSupported( "EGL_KHR_stream_producer_eglsurface" );
    if( _EGL_KHR_stream_producer_eglsurface ) load_EGL_KHR_stream_producer_eglsurface();
    _EGL_KHR_surfaceless_context = isExtSupported( "EGL_KHR_surfaceless_context" );
    _EGL_KHR_vg_parent_image = isExtSupported( "EGL_KHR_vg_parent_image" );
    _EGL_KHR_wait_sync = isExtSupported( "EGL_KHR_wait_sync" );
    if( _EGL_KHR_wait_sync ) load_EGL_KHR_wait_sync();
    _EGL_ANDROID_blob_cache = isExtSupported( "EGL_ANDROID_blob_cache" );
    if( _EGL_ANDROID_blob_cache ) load_EGL_ANDROID_blob_cache();
    _EGL_ANDROID_framebuffer_target = isExtSupported( "EGL_ANDROID_framebuffer_target" );
    _EGL_ANDROID_image_native_buffer = isExtSupported( "EGL_ANDROID_image_native_buffer" );
    _EGL_ANDROID_native_fence_sync = isExtSupported( "EGL_ANDROID_native_fence_sync" );
    if( _EGL_ANDROID_native_fence_sync ) load_EGL_ANDROID_native_fence_sync();
    _EGL_ANDROID_recordable = isExtSupported( "EGL_ANDROID_recordable" );
    _EGL_ANGLE_d3d_share_handle_client_buffer = isExtSupported( "EGL_ANGLE_d3d_share_handle_client_buffer" );
    _EGL_ANGLE_query_surface_pointer = isExtSupported( "EGL_ANGLE_query_surface_pointer" );
    if( _EGL_ANGLE_query_surface_pointer ) load_EGL_ANGLE_query_surface_pointer();
    _EGL_ANGLE_surface_d3d_texture_2d_share_handle = isExtSupported( "EGL_ANGLE_surface_d3d_texture_2d_share_handle" );
    _EGL_ARM_pixmap_multisample_discard = isExtSupported( "EGL_ARM_pixmap_multisample_discard" );
    _EGL_EXT_buffer_age = isExtSupported( "EGL_EXT_buffer_age" );
    _EGL_EXT_client_extensions = isExtSupported( "EGL_EXT_client_extensions" );
    _EGL_EXT_create_context_robustness = isExtSupported( "EGL_EXT_create_context_robustness" );
    _EGL_EXT_device_base = isExtSupported( "EGL_EXT_device_base" );
    if( _EGL_EXT_device_base ) load_EGL_EXT_device_base();
    _EGL_EXT_image_dma_buf_import = isExtSupported( "EGL_EXT_image_dma_buf_import" );
    _EGL_EXT_multiview_window = isExtSupported( "EGL_EXT_multiview_window" );
    _EGL_EXT_platform_base = isExtSupported( "EGL_EXT_platform_base" );
    if( _EGL_EXT_platform_base ) load_EGL_EXT_platform_base();
    _EGL_EXT_platform_device = isExtSupported( "EGL_EXT_platform_device" );
    _EGL_EXT_platform_wayland = isExtSupported( "EGL_EXT_platform_wayland" );
    _EGL_EXT_platform_x11 = isExtSupported( "EGL_EXT_platform_x11" );
    _EGL_EXT_protected_surface = isExtSupported( "EGL_EXT_protected_surface" );
    _EGL_EXT_swap_buffers_with_damage = isExtSupported( "EGL_EXT_swap_buffers_with_damage" );
    if( _EGL_EXT_swap_buffers_with_damage ) load_EGL_EXT_swap_buffers_with_damage();
    _EGL_HI_clientpixmap = isExtSupported( "EGL_HI_clientpixmap" );
    if( _EGL_HI_clientpixmap ) load_EGL_HI_clientpixmap();
    _EGL_HI_colorformats = isExtSupported( "EGL_HI_colorformats" );
    _EGL_IMG_context_priority = isExtSupported( "EGL_IMG_context_priority" );
    _EGL_MESA_drm_image = isExtSupported( "EGL_MESA_drm_image" );
    if( _EGL_MESA_drm_image ) load_EGL_MESA_drm_image();
    _EGL_MESA_platform_gbm = isExtSupported( "EGL_MESA_platform_gbm" );
    _EGL_NOK_swap_region = isExtSupported( "EGL_NOK_swap_region" );
    _EGL_NOK_swap_region2 = isExtSupported( "EGL_NOK_swap_region2" );
    _EGL_NOK_texture_from_pixmap = isExtSupported( "EGL_NOK_texture_from_pixmap" );
    _EGL_NV_3dvision_surface = isExtSupported( "EGL_NV_3dvision_surface" );
    _EGL_NV_coverage_sample = isExtSupported( "EGL_NV_coverage_sample" );
    _EGL_NV_coverage_sample_resolve = isExtSupported( "EGL_NV_coverage_sample_resolve" );
    _EGL_NV_depth_nonlinear = isExtSupported( "EGL_NV_depth_nonlinear" );
    _EGL_NV_native_query = isExtSupported( "EGL_NV_native_query" );
    if( _EGL_NV_native_query ) load_EGL_NV_native_query();
    _EGL_NV_post_convert_rounding = isExtSupported( "EGL_NV_post_convert_rounding" );
    _EGL_NV_post_sub_buffer = isExtSupported( "EGL_NV_post_sub_buffer" );
    if( _EGL_NV_post_sub_buffer ) load_EGL_NV_post_sub_buffer();
    _EGL_NV_stream_sync = isExtSupported( "EGL_NV_stream_sync" );
    if( _EGL_NV_stream_sync ) load_EGL_NV_stream_sync();
    _EGL_NV_sync = isExtSupported( "EGL_NV_sync" );
    if( _EGL_NV_sync ) load_EGL_NV_sync();
    _EGL_NV_system_time = isExtSupported( "EGL_NV_system_time" );
